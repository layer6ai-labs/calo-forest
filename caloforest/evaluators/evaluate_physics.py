...
from ..datasets.high_level_features import HighLevelFeatures as HLF
from caloforest.datasets.calo_challenge_showers import get_raw_data_arrays
...
def get_particle_xml(dataset):
        ...
        xml_filename = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))),
                                                    "datasets", "binning", f"binning_dataset_{dataset}.xml")
        return particle, xml_filename

def evaluate_physics_samples(gen_showers, gen_energies, cfg, logdir):
    # Similar to __main__
    ...
    print("Plotting individual showers...")
    gen_hlf.DrawSingleShower(gen_showers[0:3], output_dir+"/shower_gen.png", show=False)
    ref_hlf.DrawSingleShower(ref_showers[0:3], output_dir+"/shower_ref.png", show=False)
